# Color files
PFILE="$HOME/.config/polybar/polybar/colors.ini"
RFILE="$HOME/.config/polybar/polybar/scripts/rofi/colors.rasi"
...
/home/zelzahn/config-files/pywal-discord/pywal-discord
